...
unless defined? SpecHelper
  ...
  unless test_against_installation
    ...
    require "#{File.dirname(__FILE__)}/../../../public/script/glycerin"
  end
  ...
  module OgSpec
    ...
    def launch_og(config_type, classes)
      @managers ||= []
      @stores ||= []
      defaults = { :destroy => true, :name => 'test', :classes => classes }
    ...
    alias_method :quick_setup, :og_setup
  ...
  module Spec::Runner::ContextEval::InstanceMethods
    include OgSpec
  end
end
